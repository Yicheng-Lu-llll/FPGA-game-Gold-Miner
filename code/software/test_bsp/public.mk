...
# setting SOPC_SYSID_BASE_ADDRESS is 0x338
SOPC_SYSID_FLAG += --sidp=0x338
ELF_PATCH_FLAG  += --sidp 0x338

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1608980315
SOPC_SYSID_FLAG += --timestamp=1608980315
ELF_PATCH_FLAG  += --timestamp 1608980315
